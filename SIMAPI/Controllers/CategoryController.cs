...
namespace SIMAPI.Controllers
{
    ...
    public class CategoryController : BaseController
    {
        ...
        {
            var result = await _service.ExportAllCategoriesAsync();
            string excelName = $"CategoryList.xlsx";
            var stream = ExcelUtility.ConvertDataToExcelFormat<ExportCategory>(result.data as List<ExportCategory>);
